...
class _SettingsPageState extends State<SettingsPage> {
  ...
  _SettingsPageState({required this.title, required this.user, required this.projectIDs, required this.projects});
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> screens = [const ProfilePage(),projectsPage(title: 'My Projects', email: user, projectIDs: projectIDs, projects: projects,),const NotificationsDetailsTool(),const SettingsInterface(),];
